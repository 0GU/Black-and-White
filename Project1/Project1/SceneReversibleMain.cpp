...
void CSceneReversibleMain::InitScene()
{
	...
	Draw::LoadImage(L"まとめ画像/RSGパネルまとめ（透過済）.png", 6, TEX_SIZE_1024);
	Draw::LoadImage(L"まとめ画像/まとめ画像3.png", 7, TEX_SIZE_1024);
	...
	Draw::LoadImage(L"まとめ画像/まとめ画像1.png", 13, TEX_SIZE_1024);
	Draw::LoadImage(L"まとめ画像/help5.png", 14, TEX_SIZE_1024);
	Draw::LoadImage(L"まとめ画像/help6.png", 15, TEX_SIZE_1024);
